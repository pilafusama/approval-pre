...
public class FlowPaymentQueryRes extends BankProxyRelayResponseMsg {
    ...
    public FlowPaymentQueryRes(int result, String resInfo,String bankResult, String bankResInfo) {
