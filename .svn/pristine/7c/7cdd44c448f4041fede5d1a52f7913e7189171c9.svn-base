...
public class CorpBindAuthenReqBody {
	//银行标识
	...
	public CorpBindAuthenReqBody(CorpBindAuthenReq corpBindAuthenReq){
		this.setBankAppid(corpBindAuthenReq.getBankAppid());
		this.setBankUin(corpBindAuthenReq.getBankUin());
		this.setCertId(corpBindAuthenReq.getCertId());
		this.setCorpId(corpBindAuthenReq.getCorpId());
		this.setCorpName(corpBindAuthenReq.getCorpName());
		this.setOpUserId(corpBindAuthenReq.getOpUserId());
		this.setOpUserPhone(corpBindAuthenReq.getOpUserPhone());
		this.setStatus(corpBindAuthenReq.getStatus());
	}
